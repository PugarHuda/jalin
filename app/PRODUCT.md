...
- 141 SDK tests; 408 Playwright tests across six projects (desktop 136, firefox
  105, webkit 105, mobile 11, mobile-safari 11, ready 2) on three engines; 52
  Cairo tests of which nine fork mainnet: seven run the router against Endur,
  AVNU, Vesu and StarkGate, two run the deployed shadow-account anonymizer. Count them before quoting them; this line has been
...
- A demo video exists and ships from the app: `app/public/jalin-demo.mp4`,
  28,153,361 bytes (28.2 MB), 1920x1080, 3:38 by `ffprobe`, rebuilt on 7
