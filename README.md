...
40 tests, two of them fuzzed at 256 runs each, covering every line of every
...
```bash
npm test                      # 67 SDK tests, no build step
npm run test:e2e              # 87 Playwright tests against a real build
```
